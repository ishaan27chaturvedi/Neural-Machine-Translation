...
class NmtModel(object):
  ...
  def build(self):
    ...
    embeddings_source = Embedding(mask_zero = True, input_dim = self.vocab_source_size, output_dim = self.embedding_size, embeddings_initializer='random_uniform')(source_words)
    embeddings_target = Embedding(mask_zero = True, input_dim = self.vocab_target_size, output_dim = self.embedding_size, embeddings_initializer='random_uniform')(target_words)
    ...
    source_word_embeddings = Dropout(self.embedding_dropout_rate, input_shape=(None,))(embeddings_source)

    target_words_embeddings = Dropout(self.embedding_dropout_rate, input_shape=(None,))(embeddings_target)
  ...
  def eval(self, dataset):
    ...
    for i in range(0,5):
        print(i,".")
        print("Sample Output:", ' '.join(references[i][0]))
        print("Predicted Output:", ' '.join(candidates[i]))
